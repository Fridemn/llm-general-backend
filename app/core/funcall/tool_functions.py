...
# 生成可用函数定义列表
AVAILABLE_FUNCTIONS = [func.get_definition() for func in function_instances.values()]

# 函数名到need_llm标志的映射
FUNCTION_NEED_LLM = {func_name: func.need_llm for func_name, func in function_instances.items()}
